module.exports = [
  {
    name: "Perfect Home",
    technologies: ["MERN", "Firebase", "Stripe", "React hook form", "Tailwindcss", "Vitejs"],
    ...
    features: [
      {
        ...
        points: [
          ...
          "Credit card payment is handled with stripe.",
          "Admin users can add new services.",
          "Users can write a review for a service."
        ]
      },
      {
        title: "Admin support",
  ...
  {
    name: "Artpress",
    technologies: ["MERN", "Firebase", "React hook form", "Tailwindcss", "Vitejs"],
    github: "https://github.com/ashutoshbw314/artpress-client",
    website: "https://art-press.web.app/",
    features: [
      {
        title: "Overview",
    ...
    features: [
      {
        ...
        points: [
          ...
          "One can select a vehicle of choice.",
        ]
      },
      {
  ...
  {
    name: "Meal Matcher",
    technologies: ["JavaScript", "HTML", "CSS", "themealdb api"],
    github: "https://github.com/ashutoshbw314/meal-matcher",
    website: "https://ashutoshbw314.github.io/meal-matcher/index.html",
    features: [
      {
        title: "Overview",
